...
object AppLib {
    ...
    const val COMPOSE_MATERIAL_YOU = "androidx.compose.material3:material3"
    ...
    const val ROOM_COMPILER = "androidx.room:room-compiler:${AppVersion.ROOM_VERSION}"
    const val ROOM_COROUTINE = "androidx.room:room-ktx:${AppVersion.ROOM_VERSION}"
}